...
"""Core modules matching reference RVC implementation."""
...
from src.models.commons import get_padding, init_weights, fused_add_tanh_sigmoid_multiply
...
class WN(torch.nn.Module):
    """WaveNet-style encoder used in posterior encoder and flow."""
    def __init__(
        self,
        hidden_channels,
        kernel_size,
...
class Flip(nn.Module):
    """Channel flip layer for normalizing flow."""
    def forward(
        self,
        x: torch.Tensor,
        x_mask: torch.Tensor,
